...
class HashTable implements Serializable
{
    ...
    public void add(String key, Object value)
    {
        ...
        {
            System.out.println("Item placed at" + hashKey);
    ...
    public void remove(String key)
    {
        ...
        {
            System.out.println("Item removed at" + hashKey);
    ...
    public static void main(String[] args) 
    {
        try
        {
            ...
            reader.readFile("RandomNames7000.csv", table);
            System.out.println("Size of the array " +table.getSize());
            System.out.println("Items in the hash table " +table.getCount());
            System.out.println("Prime number should be equal to the size of array " 
                                                                            + table.primeSize);
            System.out.println("Load factor of table >60% is: " +table.loadFactor());
            System.out.println("Item at array 5000 " + table.hashArray[5000].getKey());
            table.save("result.txt");

            System.out.println("Searching for Tony Gilroy: " + table.get("Tony Gilroy"));
            /*table.reSize();
